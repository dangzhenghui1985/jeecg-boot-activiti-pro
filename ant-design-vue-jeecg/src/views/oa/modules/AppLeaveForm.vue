    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="天数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="days">
              <a-input v-model="model.days" placeholder="请输入天数"  ></a-input>
            </a-form-model-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/oa/appLeave/add",
          edit: "/oa/appLeave/edit",
          queryById: "/oa/appLeave/queryById"
        }
      }
    },
    computed: {
