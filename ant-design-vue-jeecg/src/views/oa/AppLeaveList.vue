<template>
  <a-card :bordered="false">
    ...
    <app-leave-modal ref="modalForm" @ok="modalFormOk"></app-leave-modal>
  </a-card>
</template>
...
<script>
  ...
  import AppLeaveModal from './modules/AppLeaveModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/oa/appLeave/list",
          delete: "/oa/appLeave/delete",
          deleteBatch: "/oa/appLeave/deleteBatch",
          exportXlsUrl: "/oa/appLeave/exportXls",
          importExcelUrl: "oa/appLeave/importExcel",
          startProcess: '/act/process/extActProcess/startMutilProcess'
        },
        //代码生成后需手动设置流程编码
        flowCode: 'dev_app_leave_001',
        dictOptions:{},
        superFieldList:[],
      }
    },
        ...
        this.$confirm({
          ...
          onOk:()=>{
            let params = {
              ...
              id: record.id,
              formUrl: 'oa/modules/AppLeaveForm',
              formUrlMobile: ''
            }
